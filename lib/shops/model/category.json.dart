...
CategoryModel _$CategoryModelFromJson(Map<String, dynamic> json) {
  return CategoryModel(
     ...
     selected:  json['Cat_Seleccion'] as String, // agrega  este campo en la tabla categorias y enviamelo como false, el primer item que se llame todos como nombre de categoria  con valor true como Cat_ select
...
Map<String, dynamic> _$CategoryModelToJson(CategoryModel instance) =>
    <String, dynamic>{
      ...
      'Cat_Tipo_Dx':instance.fontFamily
    };
