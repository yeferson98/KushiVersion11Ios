...
class CategoriesIconsCarouselWidget extends StatefulWidget {
  ...
  CategoriesIconsCarouselWidget(
      {Key key, this.heroTag, this.onChanged, this.category, @required this.business})
      : super(key: key);
...
class _CategoriesIconsCarouselWidgetState
  ...
  void getategory() async {
    ...
    listcategory = await _serviceTodoRapidAPI.fetchCategoryRepository(widget.business.uid.toString());
    setState(() {
